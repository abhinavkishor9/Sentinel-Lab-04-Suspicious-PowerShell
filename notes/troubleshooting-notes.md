# Troubleshooting Notes — Sentinel Lab 04
...
The lab successfully demonstrated PowerShell investigation and detection logic using synthetic Sentinel telemetry.

The main technical lesson was that **contextual correlation produces a stronger SOC detection than simply searching for `powershell.exe`**.
